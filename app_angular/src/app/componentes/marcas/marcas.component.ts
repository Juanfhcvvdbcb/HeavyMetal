...
import { ServicioMarcasService } from 'app/servicios/servicio-marcas.service';
...
export class MarcasComponent implements OnInit {
  ...
  constructor(public ServicioMarcasService: ServicioMarcasService, private http: HttpClient) {
